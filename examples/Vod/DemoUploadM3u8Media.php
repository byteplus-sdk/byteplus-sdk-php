...
$space = '';
$filePath = "path/to/your/video.m3u8";
...
$request->setFileName("your_path/vod.m3u8"); // Set file name. To avoid TS file path overwriting, it is recommended to specify
$request->setFunctions($functions);
$request->setCallbackArgs("my callback");
$request->setSupportParseManifest(true);
