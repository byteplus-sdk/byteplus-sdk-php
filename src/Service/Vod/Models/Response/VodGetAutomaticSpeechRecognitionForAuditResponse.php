...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Response.VodGetAutomaticSpeechRecognitionForAuditResponse</code>
 */
class VodGetAutomaticSpeechRecognitionForAuditResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *响应结果
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodGetAutomaticSpeechRecognitionForAuditResult Result = 2;</code>
     */
     ...
     *          响应通用信息
     *     @type \Byteplus\Service\Vod\Models\Business\VodGetAutomaticSpeechRecognitionForAuditResult $Result
     *          响应结果
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodGetAutomaticSpeechRecognitionForAuditResult Result = 2;</code>
     * @return \Byteplus\Service\Vod\Models\Business\VodGetAutomaticSpeechRecognitionForAuditResult|null
     */
     ...
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodGetAutomaticSpeechRecognitionForAuditResult Result = 2;</code>
     * @param \Byteplus\Service\Vod\Models\Business\VodGetAutomaticSpeechRecognitionForAuditResult $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Byteplus\Service\Vod\Models\Business\VodGetAutomaticSpeechRecognitionForAuditResult::class);
        $this->Result = $var;
