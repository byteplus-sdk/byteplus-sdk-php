...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Response.VodListWorkflowExecutionResponse</code>
 */
class VodListWorkflowExecutionResponse extends \Google\Protobuf\Internal\Message
{
     ...
     * 响应结果
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodListWorkflowExecutionResult Result = 2;</code>
     */
     ...
     *           响应通用信息
     *     @type \Byteplus\Service\Vod\Models\Business\VodListWorkflowExecutionResult $Result
     *           响应结果
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodListWorkflowExecutionResult Result = 2;</code>
     * @return \Byteplus\Service\Vod\Models\Business\VodListWorkflowExecutionResult|null
     */
     ...
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodListWorkflowExecutionResult Result = 2;</code>
     * @param \Byteplus\Service\Vod\Models\Business\VodListWorkflowExecutionResult $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Byteplus\Service\Vod\Models\Business\VodListWorkflowExecutionResult::class);
        $this->Result = $var;
