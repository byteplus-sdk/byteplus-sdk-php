...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Response.VodListSpaceResponse</code>
 */
class VodListSpaceResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *响应结果
     *
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.VodSpaceInfo Result = 2;</code>
     */
    private $Result;
     ...
     *          响应通用信息
     *     @type \Byteplus\Service\Vod\Models\Business\VodSpaceInfo[]|\Google\Protobuf\Internal\RepeatedField $Result
     *          响应结果
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.VodSpaceInfo Result = 2;</code>
     * @param \Byteplus\Service\Vod\Models\Business\VodSpaceInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResult($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Byteplus\Service\Vod\Models\Business\VodSpaceInfo::class);
        $this->Result = $arr;
