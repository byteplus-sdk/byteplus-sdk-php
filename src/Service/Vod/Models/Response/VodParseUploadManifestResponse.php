...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Response.VodParseUploadManifestResponse</code>
 */
class VodParseUploadManifestResponse extends \Google\Protobuf\Internal\Message
{
    /**
     * 通用返回结构 
     *
     ...
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodParseUploadManifestResult Result = 2;</code>
     */
     ...
     *           通用返回结构 
     *     @type \Byteplus\Service\Vod\Models\Business\VodParseUploadManifestResult $Result
     *           解析HLS Manifest返回的分片列表 
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodParseUploadManifestResult Result = 2;</code>
     * @return \Byteplus\Service\Vod\Models\Business\VodParseUploadManifestResult|null
     */
     ...
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodParseUploadManifestResult Result = 2;</code>
     * @param \Byteplus\Service\Vod\Models\Business\VodParseUploadManifestResult $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Byteplus\Service\Vod\Models\Business\VodParseUploadManifestResult::class);
        $this->Result = $var;
