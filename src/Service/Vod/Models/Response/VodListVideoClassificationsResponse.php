...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Response.VodListVideoClassificationsResponse</code>
 */
class VodListVideoClassificationsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *响应结果
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodVideoClassificationsData Result = 2;</code>
     */
     ...
     *          响应通用信息
     *     @type \Byteplus\Service\Vod\Models\Business\VodVideoClassificationsData $Result
     *          响应结果
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodVideoClassificationsData Result = 2;</code>
     * @return \Byteplus\Service\Vod\Models\Business\VodVideoClassificationsData|null
     */
     ...
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodVideoClassificationsData Result = 2;</code>
     * @param \Byteplus\Service\Vod\Models\Business\VodVideoClassificationsData $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Byteplus\Service\Vod\Models\Business\VodVideoClassificationsData::class);
        $this->Result = $var;
