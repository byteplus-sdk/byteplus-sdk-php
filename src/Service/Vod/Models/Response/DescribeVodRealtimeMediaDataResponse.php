 ...
 * 点播实时处理用量
 *
 * Generated from protobuf message <code>Byteplus.Vod.Models.Response.DescribeVodRealtimeMediaDataResponse</code>
 */
class DescribeVodRealtimeMediaDataResponse extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.DescribeVodRealtimeMediaDataResult Result = 2;</code>
     */
     ...
     *     @type \Byteplus\Service\Vod\Models\Business\DescribeVodRealtimeMediaDataResult $Result
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.DescribeVodRealtimeMediaDataResult Result = 2;</code>
     * @return \Byteplus\Service\Vod\Models\Business\DescribeVodRealtimeMediaDataResult|null
     */
    ...
    /**
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.DescribeVodRealtimeMediaDataResult Result = 2;</code>
     * @param \Byteplus\Service\Vod\Models\Business\DescribeVodRealtimeMediaDataResult $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Byteplus\Service\Vod\Models\Business\DescribeVodRealtimeMediaDataResult::class);
        $this->Result = $var;
