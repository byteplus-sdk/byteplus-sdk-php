...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Response.VodListSnapshotsResponse</code>
 */
class VodListSnapshotsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *响应结果
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodSnapshotData Result = 2;</code>
     */
     ...
     *          响应通用信息
     *     @type \Byteplus\Service\Vod\Models\Business\VodSnapshotData $Result
     *          响应结果
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodSnapshotData Result = 2;</code>
     * @return \Byteplus\Service\Vod\Models\Business\VodSnapshotData|null
     */
     ...
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodSnapshotData Result = 2;</code>
     * @param \Byteplus\Service\Vod\Models\Business\VodSnapshotData $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Byteplus\Service\Vod\Models\Business\VodSnapshotData::class);
        $this->Result = $var;
