...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Response.VodListFileMetaInfosByFileNamesResponse</code>
 */
class VodListFileMetaInfosByFileNamesResponse extends \Google\Protobuf\Internal\Message
{
     ...
     * 响应结果 
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodListFileMetaInfosByFileNamesResult Result = 2;</code>
     */
     ...
     *           通用返回结构 
     *     @type \Byteplus\Service\Vod\Models\Business\VodListFileMetaInfosByFileNamesResult $Result
     *           响应结果 
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodListFileMetaInfosByFileNamesResult Result = 2;</code>
     * @return \Byteplus\Service\Vod\Models\Business\VodListFileMetaInfosByFileNamesResult|null
     */
     ...
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodListFileMetaInfosByFileNamesResult Result = 2;</code>
     * @param \Byteplus\Service\Vod\Models\Business\VodListFileMetaInfosByFileNamesResult $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Byteplus\Service\Vod\Models\Business\VodListFileMetaInfosByFileNamesResult::class);
        $this->Result = $var;
