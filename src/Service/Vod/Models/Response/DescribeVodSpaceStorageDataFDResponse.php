 ...
 * 存储用量小时延迟数据-定制化
 *
 * Generated from protobuf message <code>Byteplus.Vod.Models.Response.DescribeVodSpaceStorageDataFDResponse</code>
 */
class DescribeVodSpaceStorageDataFDResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.DescribeVodSpaceStorageDataFDResult Result = 2;</code>
     */
     ...
     *     @type \Byteplus\Service\Vod\Models\Business\DescribeVodSpaceStorageDataFDResult $Result
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.DescribeVodSpaceStorageDataFDResult Result = 2;</code>
     * @return \Byteplus\Service\Vod\Models\Business\DescribeVodSpaceStorageDataFDResult|null
     */
    ...
    /**
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.DescribeVodSpaceStorageDataFDResult Result = 2;</code>
     * @param \Byteplus\Service\Vod\Models\Business\DescribeVodSpaceStorageDataFDResult $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Byteplus\Service\Vod\Models\Business\DescribeVodSpaceStorageDataFDResult::class);
        $this->Result = $var;
