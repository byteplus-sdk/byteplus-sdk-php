 ...
 * 存储用量小时延迟数据-定制化
 *
 * Generated from protobuf message <code>Byteplus.Vod.Models.Business.DescribeVodSpaceStorageDataFDItem</code>
 */
class DescribeVodSpaceStorageDataFDItem extends \Google\Protobuf\Internal\Message
{
    /**
