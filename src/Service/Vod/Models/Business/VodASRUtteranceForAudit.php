...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Business.VodASRUtteranceForAudit</code>
 */
class VodASRUtteranceForAudit extends \Google\Protobuf\Internal\Message
{
     ...
     * 分词
     *
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.VodASRUtteranceWordForAudit Words = 4;</code>
     */
    private $Words;
    /**
     * 分句的被识别成的语言
     ...
     *           结束时间(毫秒)
     *     @type \Byteplus\Service\Vod\Models\Business\VodASRUtteranceWordForAudit[]|\Google\Protobuf\Internal\RepeatedField $Words
     *           分词
     ...
     *
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.VodASRUtteranceWordForAudit Words = 4;</code>
     * @param \Byteplus\Service\Vod\Models\Business\VodASRUtteranceWordForAudit[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setWords($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Byteplus\Service\Vod\Models\Business\VodASRUtteranceWordForAudit::class);
        $this->Words = $arr;
