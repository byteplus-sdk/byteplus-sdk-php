...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Business.VodAllPlayInfoResult</code>
 */
class VodAllPlayInfoResult extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.VodAllPlayInfoModel VodAllPlayInfoModelList = 1;</code>
     */
     ...
     *
     *     @type \Byteplus\Service\Vod\Models\Business\VodAllPlayInfoModel[]|\Google\Protobuf\Internal\RepeatedField $VodAllPlayInfoModelList
     *     @type int $TotalCount
     *           查到多少个vid
    ...
    /**
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.VodAllPlayInfoModel VodAllPlayInfoModelList = 1;</code>
     * @param \Byteplus\Service\Vod\Models\Business\VodAllPlayInfoModel[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setVodAllPlayInfoModelList($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Byteplus\Service\Vod\Models\Business\VodAllPlayInfoModel::class);
