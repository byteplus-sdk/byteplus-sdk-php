...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Business.VodGetWorkflowExecutionDetailResult</code>
 */
class VodGetWorkflowExecutionDetailResult extends \Google\Protobuf\Internal\Message
{
     ...
     * 执行阶段
     *
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.ExecutionStage Stages = 10;</code>
     */
    private $Stages;
    /**
    ...
    /**
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.DirectUrl DirectUrl = 14;</code>
     */
     ...
     *     @type \Byteplus\Service\Vod\Models\Business\ExecutionStage[]|\Google\Protobuf\Internal\RepeatedField $Stages
     *           执行阶段
     ...
     *
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.ExecutionStage Stages = 10;</code>
     * @param \Byteplus\Service\Vod\Models\Business\ExecutionStage[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setStages($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Byteplus\Service\Vod\Models\Business\ExecutionStage::class);
        $this->Stages = $arr;
