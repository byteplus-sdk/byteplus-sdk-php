...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Business.StageDetail</code>
 */
class StageDetail extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.StageStatus Status = 5;</code>
     */
    protected $Status = 0;
    /**
     * 错误码
    ...
    {
        GPBUtil::checkEnum($var, \Byteplus\Service\Vod\Models\Business\StageStatus::class);
        $this->Status = $var;
