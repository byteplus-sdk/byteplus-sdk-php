...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Business.VodDomainoInfo</code>
 */
class VodDomainoInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *证书
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodDomainCertificateInfo Certificate = 6;</code>
     */
     ...
     * 源站信息
     *
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.VodDomainSourceInfo Sources = 10;</code>
     */
    private $Sources;
    /**
     *是否锁定，可否配置
     ...
     *     @type string $Status
     *          运行状态
     *     @type \Byteplus\Service\Vod\Models\Business\VodDomainCertificateInfo $Certificate
     *          证书
     ...
     *     @type string $Region
     *          加速区域，cn:国内,overseas:海外，global:全球
     *     @type \Byteplus\Service\Vod\Models\Business\VodDomainSourceInfo[]|\Google\Protobuf\Internal\RepeatedField $Sources
     *           源站信息
     ...
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodDomainCertificateInfo Certificate = 6;</code>
     * @return \Byteplus\Service\Vod\Models\Business\VodDomainCertificateInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.VodDomainCertificateInfo Certificate = 6;</code>
     * @param \Byteplus\Service\Vod\Models\Business\VodDomainCertificateInfo $var
     * @return $this
     */
    public function setCertificate($var)
    {
        GPBUtil::checkMessage($var, \Byteplus\Service\Vod\Models\Business\VodDomainCertificateInfo::class);
     ...
     *
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.VodDomainSourceInfo Sources = 10;</code>
     * @param \Byteplus\Service\Vod\Models\Business\VodDomainSourceInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSources($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Byteplus\Service\Vod\Models\Business\VodDomainSourceInfo::class);
        $this->Sources = $arr;
