...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Business.CommitUploadInfoParam</code>
 */
class CommitUploadInfoParam extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.VodUploadFunction Functions = 4;</code>
     */
    private $Functions;
    /**
     ...
     *     @type \Byteplus\Service\Vod\Models\Business\VodUploadFunction[]|\Google\Protobuf\Internal\RepeatedField $Functions
    ...
    /**
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.VodUploadFunction Functions = 4;</code>
     * @param \Byteplus\Service\Vod\Models\Business\VodUploadFunction[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFunctions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Byteplus\Service\Vod\Models\Business\VodUploadFunction::class);
        $this->Functions = $arr;
