...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Business.TranscodeAudioOverride</code>
 */
class TranscodeAudioOverride extends \Google\Protobuf\Internal\Message
{
    ...
    private $TemplateId;
    /**
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.Clip Clip = 2;</code>
     */
    protected $Clip = null;
    /**
     * 文件名
     ...
     *           被覆盖的音频模板Id, 支持ALL
     *     @type \Byteplus\Service\Vod\Models\Business\Clip $Clip
    ...
    /**
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.Clip Clip = 2;</code>
     * @return \Byteplus\Service\Vod\Models\Business\Clip|null
     */
    ...
    /**
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.Clip Clip = 2;</code>
     * @param \Byteplus\Service\Vod\Models\Business\Clip $var
     * @return $this
     */
    public function setClip($var)
    {
        GPBUtil::checkMessage($var, \Byteplus\Service\Vod\Models\Business\Clip::class);
        $this->Clip = $var;
