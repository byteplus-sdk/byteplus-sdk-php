...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Business.VodGetFileListData</code>
 */
class VodGetFileListData extends \Google\Protobuf\Internal\Message
{
     ...
     *对象列表
     *
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.FileBasicInfo FileBasicInfos = 5;</code>
     */
     ...
     *          如果有截断的话，下一个列举对象的起始位置
     *     @type \Byteplus\Service\Vod\Models\Business\FileBasicInfo[]|\Google\Protobuf\Internal\RepeatedField $FileBasicInfos
     *          对象列表
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.FileBasicInfo FileBasicInfos = 5;</code>
     * @param \Byteplus\Service\Vod\Models\Business\FileBasicInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFileBasicInfos($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Byteplus\Service\Vod\Models\Business\FileBasicInfo::class);
