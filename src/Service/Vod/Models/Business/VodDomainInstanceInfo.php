...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Business.VodDomainInstanceInfo</code>
 */
class VodDomainInstanceInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *域名列表
     *
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.VodDomainoInfo Domains = 2;</code>
     */
    private $Domains;
    /**
     *是否可自助配置，废弃
     ...
     *          实例ID，废弃
     *     @type \Byteplus\Service\Vod\Models\Business\VodDomainoInfo[]|\Google\Protobuf\Internal\RepeatedField $Domains
     *          域名列表
     ...
     *
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.VodDomainoInfo Domains = 2;</code>
     * @param \Byteplus\Service\Vod\Models\Business\VodDomainoInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setDomains($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Byteplus\Service\Vod\Models\Business\VodDomainoInfo::class);
        $this->Domains = $arr;
