...
/**
 * Generated from protobuf message <code>Byteplus.Vod.Models.Business.VodWorkflowResult</code>
 */
class VodWorkflowResult extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.Byteplus.Vod.Models.Business.DirectUrl DirectUrl = 1;</code>
     */
    ...
    protected $Status = '';
    /**
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.VodTranscodeInfo TranscodeInfos = 8;</code>
     */
    private $TranscodeInfos;
    /**
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.SnapshotResult Snapshots = 9;</code>
     */
    private $Snapshots;
     ...
     *     @type \Byteplus\Service\Vod\Models\Business\SnapshotResult[]|\Google\Protobuf\Internal\RepeatedField $Snapshots
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.VodTranscodeInfo TranscodeInfos = 8;</code>
     * @param \Byteplus\Service\Vod\Models\Business\VodTranscodeInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .Byteplus.Vod.Models.Business.SnapshotResult Snapshots = 9;</code>
     * @param \Byteplus\Service\Vod\Models\Business\SnapshotResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSnapshots($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Byteplus\Service\Vod\Models\Business\SnapshotResult::class);
        $this->Snapshots = $arr;
