...
class Live extends V4Curl
{
    ...
    public function listStorageSpace(array $query = []): string
    {
         return $this->requestWithRetry("ListStorageSpace", $query);
    }

    public function describeLiveStorageSpaceData(array $query = []): string
    {
        return $this->requestWithRetry("DescribeLiveStorageSpaceData", $query);
    }
}
